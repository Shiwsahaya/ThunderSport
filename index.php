...
<a href="#events" class="col-md-6 colors-e background-95-e full-height">
<div>
...
<div class="row full-height">
<a href="#contact" class="col-md-4 colors-g background-solid full-height border-bottom border-lite">
<div>
...
<ul class="texts">
<li>We Are Game Changers</li>
<li>We Are Players</li>
...
<div class="col-content">
<h4>WHAT YOU TAKE BACK</h4>
<p class="justify">It's about making memories, and living them. Everytime you
...
<div class="caption">Fb Reach</div>
</div>
</div>
</div>
</div>
...
<div class="container">
<h2>Gallery</h2>
<p class="header-details"><span class="highlight">Some Recent</span> Memories</p>
</div>
...
<a href="team.html" class="button background-60-f heading-f border-hard">View All Team Members</a>
</div>
...
<h3 class="text-left"><span class="highlight">Let's do it Again</h3>
<p>It's that time of the year again, when no ground remains quiet and no stand remains empty, when goals and baskets simply become excuses, to up the decibels and shout out loud!</p>
</div>
</div>
</div>
</div>
...
<p class="big-font uppercase">
CSA Hall<br /> KNIT Sultanpur,UP,INDIA,Pincode-228118
...
<form class="ajax-form" data-message-class="colors-d background-95 heading border" action="#" method="post" novalidate="novalidate">
<div class="row">
